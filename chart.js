...
am5.ready(function() {
        ...
        bubbleSeries.bullets.push(function(root, series, dataItem) {
            ...
            let circle = container.children.push(
                am5.Circle.new(root, {
                    ...
                    fill: am5.color(0xffec33), // red for bubbles
            ...
            circle.events.on("click", function(ev) {
                ...
                document.getElementById("chartdiv2").style.opacity = 0.5; // Reduce opacity of the map
            });
    ...
    document.getElementById("closeBtn").addEventListener("click", function() {
        ...
        document.getElementById("chartdiv2").style.opacity = 1; // Reset map opacity
    });
});